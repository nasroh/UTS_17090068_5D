<?php 
  ...
  $query = "SELECT * FROM data_admin WHERE id_admin='$id_admin'";
...
<html lang="en">
  ...
  <body>
    ...
    <h2 class="text-center mt-4">UBAH DATA ADMIN</h2>
      ...
      <div class="col-lg-8 mt-4 mb-5">
        <form action="ubah.php" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" pattern="[A-Za-z ]+" name="nama_admin" class="form-control" required value="<?php echo $tampil->nama_admin ?>">
          </div>
