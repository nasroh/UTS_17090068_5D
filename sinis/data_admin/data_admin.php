...
<html lang="en">
  ...
  <body>
    ...
    <h2 class="text-center mt-5">DATA ADMIN</h2>
        ...
        <table class="table table-striped">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <a href="form_ubah.php?id_admin=<?php echo $tampil->id_admin ?>" class="btn btn-success mr-2">Ubah</a>
                <a onclick="return confirm('HAPUS DATA INI !?')" href="hapus.php?id_admin=<?php echo $tampil->id_admin ?>" class="btn btn-danger">Hapus</a>
              </td>
            </tr>
          </tbody>
        <?php } ?>
