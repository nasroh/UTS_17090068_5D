      ...
      <div class="col-lg-11 mb-5 mt-3">
        <table class="table table-striped">
          ...
          <?php 
            ...
            $query = "SELECT data_kelas.id_kelas, data_kelas.nama_kelas, data_guru.nama_guru FROM data_kelas INNER JOIN data_guru ON data_kelas.id_guru=data_guru.id_guru";
          ...
          <tbody>
            <tr>
              ...
              <td>
                <a href="form_ubah.php?id_kelas=<?php echo $tampil->id_kelas ?>" class="btn btn-success mr-2">Ubah</a>
                <a onclick="return confirm('HAPUS DATA INI !?')" href="hapus.php?id_kelas=<?php echo $tampil->id_kelas ?>" class="btn btn-danger">Hapus</a>
              </td>
            </tr>
          </tbody>
        <?php } ?>
