      ...
      <div class="col-lg-11 mb-5 mt-3">
        <table class="table table-striped">
          ...
          <?php 
            ...
            $query = "SELECT data_siswa.id_siswa, data_siswa.nis, data_siswa.nama_siswa, data_siswa.jenis_kelamin, data_siswa.alamat, data_kelas.nama_kelas FROM data_siswa INNER JOIN data_kelas ON data_siswa.id_kelas=data_kelas.id_kelas";
          ...
          <tbody>
            <tr>
              ...
              <td>
                <a href="form_ubah.php?id_siswa=<?php echo $tampil->id_siswa ?>" class="btn btn-success mr-2">Ubah</a>
                <a onclick="return confirm('HAPUS DATA INI !?')" href="hapus.php?id_siswa=<?php echo $tampil->id_siswa ?>" class="btn btn-danger">Hapus</a>
              </td>
            </tr>
          </tbody>
        <?php } ?>
