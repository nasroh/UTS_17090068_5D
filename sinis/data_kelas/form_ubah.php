<?php 
  ...
  $query = "SELECT data_kelas.id_kelas, data_kelas.nama_kelas, data_guru.nama_guru FROM data_kelas INNER JOIN data_guru ON data_kelas.id_guru=data_guru.id_guru WHERE id_kelas='$id_kelas'";
...
<html lang="en">
  ...
  <body>
    ...
    <a href="data_kelas.php" class="btn btn-info mt-2 ml-2">Kembali</a>
      ...
      <div class="col-lg-8 mt-4 mb-5">
        <form action="ubah.php" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" name="nama_kelas" maxlength="5" class="form-control" value="<?php echo $tampil->nama_kelas; ?>" required>
          </div>
          <div class="form-group">
