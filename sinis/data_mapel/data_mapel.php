...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
              <a class="nav-link" href="data_mapel.php">Data Mapel</a>
          </li>
          <li class="nav-item">
    ...
    <h2 class="text-center mt-5">DATA MAPEL</h2>
      ...
      <div class="col-lg-11 mb-5 mt-3">
        <table class="table table-striped">
          ...
          <?php 
            ...
            $query = "SELECT data_mapel.id_mapel, data_mapel.nama_mapel, data_guru.nama_guru, data_kelas.nama_kelas FROM data_mapel INNER JOIN data_guru ON data_mapel.id_guru=data_guru.id_guru INNER JOIN data_kelas ON data_mapel.id_kelas=data_kelas.id_kelas";
          ...
          <tbody>
            <tr>
              ...
              <td>
                <a href="form_ubah.php?id_mapel=<?php echo $tampil->id_mapel ?>" class="btn btn-success mr-2">Ubah</a>
                <a onclick="return confirm('HAPUS DATA INI !?')" href="hapus.php?id_mapel=<?php echo $tampil->id_mapel ?>" class="btn btn-danger">Hapus</a>
              </td>
            </tr>
          </tbody>
        <?php } ?>
