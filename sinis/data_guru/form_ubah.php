<?php 
  ...
  $query = "SELECT * FROM data_guru WHERE id_guru='$id_guru'";
...
<html lang="en">
  ...
  <body>
    ...
    <a href="data_guru.php" class="btn btn-info mt-2 ml-2">Kembali</a>
    <h2 class="text-center mt-4">UBAH DATA GURU</h2>
      ...
      <div class="col-lg-8 mt-4 mb-5">
        <form action="ubah.php" method="post">
          ...
          <div class="form-group">
            <label>NIP</label>
            <input type="text" name="nip" maxlength="9" class="form-control" value="<?php echo $tampil->nip ?>"required>
          </div>
          <div class="form-group">
            <label>Nama Guru</label>
            <input type="text" name="nama_guru" class="form-control" value="<?php echo $tampil->nama_guru ?>"required>
          </div>
          <div class="form-group">
            <label>Gelar</label>
            <input type="text" name="gelar" class="form-control" value="<?php echo $tampil->gelar ?>"required>
          </div>
          <div class="form-group">
